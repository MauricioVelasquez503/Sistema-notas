...
<form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" id="slick-login">
  <label for="username">username</label>
  <img src="../images/banner_maestros.fw.png" width="599" height="202" >
  <input type="text" name="username" class="placeholder" placeholder="Codigo">
