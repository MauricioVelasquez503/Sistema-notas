...
if ((isset($_GET['ID_MATERIA'])) && ($_GET['ID_MATERIA'] != "")) {
  $deleteSQL = sprintf("DELETE FROM materias WHERE ID_MATERIA=%s",
                       GetSQLValueString($_GET['ID_MATERIA'], "int"));

  mysql_select_db($database_cnn, $cnn);
  $Result1 = mysql_query($deleteSQL, $cnn) or die(mysql_error());

  $deleteGoTo = "administrar_materias.php";
...
if (isset($_GET['ID_MATERIA'])) {
  $colname_eliminar = $_GET['ID_MATERIA'];
}
mysql_select_db($database_cnn, $cnn);
$query_eliminar = sprintf("SELECT * FROM materias WHERE ID_MATERIA = %s", GetSQLValueString($colname_eliminar, "int"));
$eliminar = mysql_query($query_eliminar, $cnn) or die(mysql_error());
...
<!--------------Content--------------->
<section id="content">
	<div class="zerogrid block"><!-- InstanceBeginEditable name="titulo" -->Eliminar materia
