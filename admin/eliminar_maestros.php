...
if ((isset($_GET['ID_PROFESOR'])) && ($_GET['ID_PROFESOR'] != "")) {
  $deleteSQL = sprintf("DELETE FROM maestros WHERE ID_PROFESOR=%s",
                       GetSQLValueString($_GET['ID_PROFESOR'], "int"));

  mysql_select_db($database_cnn, $cnn);
  $Result1 = mysql_query($deleteSQL, $cnn) or die(mysql_error());

  $deleteGoTo = "consultar_maestros.php";
