...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO actividades (ID_ACTIVIDAD, IDTIPO_ACTIVIDAD, STR_NOMBRE, PORCENTAJE) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "administrar_actividades.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_cnn, $cnn);
$query_Recordset1 = "SELECT * FROM tipo_actividad";
...
<section id="content">
	...
	<div class="row block01">
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table align="center">
          <tr valign="baseline">
            <td nowrap align="right">CODIGO ACTIVIDAD:</td>
            <td><input type="text" name="ID_ACTIVIDAD" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">TIPO DE ACTIVIDAD:</td>
            <td><label for="IDTIPO_ACTIVIDAD"></label>
              <select name="IDTIPO_ACTIVIDAD" id="IDTIPO_ACTIVIDAD">
                <?php
do {  
?>
                <option value="<?php echo $row_Recordset1['IDTIPO_ACTIVIDAD']?>"><?php echo $row_Recordset1['STR_NOMBRE_ACTIVIDAD']?></option>
                <?php
...
?>
          ...
          <tr valign="baseline">
            ...
            <td><textarea name="STR_NOMBRE" cols="50" rows="5"></textarea></td>
          </tr>
          <tr valign="baseline">
