...
<section id="content">
	<div class="zerogrid block"><!-- InstanceBeginEditable name="titulo" -->
	  <div class="row block03">
	    <h1>Administracion de maestros</h1>
	  </div>
	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="contenido" -->
	<div class="row block01">
	  <table width="508" height="65" border="0" align="center">
	    <tr>
	      <td width="99"><strong><a href="insertar_maestros.php">INSERTAR MAESTROS</a> </strong></td>
	      <td width="152"><strong><a href="seleccion_maestro_materia.php">ASIGNAR MAESTROS A PROFESOR</a></strong></td>
	      <td width="117"><strong><a href="consultar_maestros.php">CONSULTAR MAESTROS</a></strong></td>
        </tr>
	    <tr>
	      <td>&nbsp;</td>
	      <td><strong><a href="Selecionar_para_insertar_notas.php">INSERTRA ACTIVIDADES</a></strong></td>
	      <td><a href="Selecionar_alumnos_insertar_notas.php"><strong>INSERTAR NOTAS</strong></a></td>
        </tr>
      </table>
	</div>
