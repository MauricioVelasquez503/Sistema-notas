...
<section id="content">
	<div class="zerogrid block"><!-- InstanceBeginEditable name="titulo" -->
	  <div class="row block03">
	    <h1>Administracion de Alumo</h1>
	  </div>
	<!-- InstanceEndEditable --><!-- InstanceBeginEditable name="contenido" -->
	<div class="row block01"><a href="Grado_seccion_alumno.php"></a> 
	  <table width="333" border="0" align="center">
	    <tr>
	      <td height="20"><strong><a href="Grado_seccion_alumno.php">Insertar alumnos</a></strong></td>
	      <td> <strong><a href="alumnos_seccion.php">Ver alumnos por sección</a></strong></td>
        </tr>
      </table>
	</div>
