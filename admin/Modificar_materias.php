...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE materias SET STR_CODIGO=%s, STR_NOMBRE=%s WHERE ID_MATERIA=%s",
                       GetSQLValueString($_POST['STR_CODIGO'], "text"),
  ...
  $updateGoTo = "administrar_materias.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['ID_MATERIA'])) {
  $colname_materias = $_GET['ID_MATERIA'];
}
mysql_select_db($database_cnn, $cnn);
$query_materias = sprintf("SELECT * FROM materias WHERE ID_MATERIA = %s", GetSQLValueString($colname_materias, "int"));
...
<section id="content">
    ...
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        <tr valign="baseline">
          <td nowrap align="right">STR_CODIGO:</td>
          <td><input type="text" name="STR_CODIGO" value="<?php echo htmlentities($row_materias['STR_CODIGO'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">STR_NOMBRE:</td>
          <td><input type="text" name="STR_NOMBRE" value="<?php echo htmlentities($row_materias['STR_NOMBRE'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
      ...
      <input type="hidden" name="ID_MATERIA" value="<?php echo $row_materias['ID_MATERIA']; ?>">
    </form>
    <p>&nbsp;</p>
