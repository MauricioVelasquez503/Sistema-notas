...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO materias (STR_CODIGO, STR_NOMBRE, FECHA_REGISTRO) VALUES (%s, %s, NOW())",
  ...
  $insertGoTo = "administrar_materias.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<section id="content">
	...
	<div class="row block01">
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table align="center">
          <tr valign="baseline">
            <td nowrap align="right">CODIGO DE LA MATERIA:</td>
            <td><input type="text" name="STR_CODIGO" value="" size="8"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">NOMBRE DE LA MATERIA:</td>
            <td><input type="text" name="STR_NOMBRE" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
