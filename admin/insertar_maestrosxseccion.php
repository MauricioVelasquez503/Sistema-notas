...
$query_Recordset1 = "SELECT * FROM grados_secciones";
...
<section id="content">
	...
	<div class="row block03">
	    <h1>Insertar maestros por grado y seccion</h1>
	  </div>
	...
	<div class="row block01">
      <table border="1" align="center">
        ...
        <?php do { ?>
          <tr>
            <td height="29"><?php echo $row_Recordset1['GRADO']; ?></td>
            <td><?php echo $row_Recordset1['STR_SECCIONES']; ?></td>
            <td><a href="maestros_secciones2.php?ID_GRADO=<?php echo $row_Recordset1['ID_GRADO']; ?>&ID_SECCIONES=<?php echo $row_Recordset1['ID_SECCIONES']; ?>">Asignar</a></td>
          </tr>
