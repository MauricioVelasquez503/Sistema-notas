...
$query_Recordset1 = "SELECT * FROM alumnos_grados WHERE ID_SECCIONES = 'ID_SECCIONES'";
...
mysql_select_db($database_cnn, $cnn);
$query_Recordset1 = "SELECT * FROM alumnos_grados WHERE ID_SECCIONES = 'UV'";
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_limit_Recordset1, $cnn) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
...
<!--------------Content--------------->
<section id="content">
	<div class="zerogrid block"><!-- InstanceBeginEditable name="titulo" -->Alumnos seccion B
Prime	Grado    
      ...
      <table border="1" align="center">
        ...
        <?php do { ?>
          <tr>
            ...
            <td><?php echo $row_Recordset1['ID_ALUMNO']; ?></td>
            <td><?php echo $row_Recordset1['STR_NOMBRE_ALUMNO']; ?></td>
            <td><?php echo $row_Recordset1['STR_APELLIDO_ALUMNO']; ?></td>
            <td><?php echo $row_Recordset1['STRNIE']; ?></td>
          </tr>
