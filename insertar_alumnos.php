...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO alumnos_seccion (ID_ALUMNO, STR_NOMBRE_ALUMNO, STR_APELLIDO_ALUMNO, STRNIE,ID_GRADO,ID_SECCIONES) VALUES (%s, %s, %s, %s, %s, %s)",
...
<section id="content">
	...
	<div class="row block01">
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table align="center">
          <tr valign="baseline">
            <td nowrap align="right">ID_ALUMNO:</td>
            <td><input type="text" name="ID_ALUMNO" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">STR_NOMBRE_ALUMNO:</td>
            <td><input type="text" name="STR_NOMBRE_ALUMNO" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">STR_APELLIDO_ALUMNO:</td>
            <td><input type="text" name="STR_APELLIDO_ALUMNO" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">STRNIE:</td>
            <td><input type="text" name="STRNIE" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
        ...
        <input type="text" name="ID_GRADO" value="<?php echo $row_grados['ID_GRADO']; ?>">
        <input type="text" name="ID_SECCIONES" value="<?php echo $row_secciones['ID_SECCIONES']; ?>">
      </form>
      <p>&nbsp;</p>
	</div>
